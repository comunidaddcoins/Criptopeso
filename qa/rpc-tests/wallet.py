...
#   c) node1 mines 32 blocks, so now node 0 has 500000PESO, node 1 has 4250PESO, node2 has none.
#   d) node0 sends 601 PESO to node2, in two transactions (301 PESO, then 300 PESO).
