Contributing to Criptopeso Core
==================================

The Criptopeso Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Criptopeso Core project, and is not to be
confused with overall Criptopeso Network Protocol consensus changes.

Whether a pull request is merged into Criptopeso Core rests with the project merge
...
Patches that change Criptopeso consensus rules are considerably more involved than
...
Where a patch set proposes to change the Criptopeso consensus, it must have been
...
The project leader is the release manager for each Criptopeso Core release.
