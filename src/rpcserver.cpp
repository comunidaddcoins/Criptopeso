...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Criptopeso server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Criptopeso server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Criptopeso features */
        {"criptopeso", "masternode", &masternode, true, true, false},
        {"criptopeso", "listmasternodes", &listmasternodes, true, true, false},
        {"criptopeso", "getmasternodecount", &getmasternodecount, true, true, false},
        {"criptopeso", "masternodeconnect", &masternodeconnect, true, true, false},
        {"criptopeso", "masternodecurrent", &masternodecurrent, true, true, false},
        {"criptopeso", "masternodedebug", &masternodedebug, true, true, false},
        {"criptopeso", "startmasternode", &startmasternode, true, true, false},
        {"criptopeso", "createmasternodekey", &createmasternodekey, true, true, false},
        {"criptopeso", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"criptopeso", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"criptopeso", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"criptopeso", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"criptopeso", "getmasternodescores", &getmasternodescores, true, true, false},
        {"criptopeso", "mnbudget", &mnbudget, true, true, false},
        {"criptopeso", "preparebudget", &preparebudget, true, true, false},
        {"criptopeso", "submitbudget", &submitbudget, true, true, false},
        {"criptopeso", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"criptopeso", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"criptopeso", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"criptopeso", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"criptopeso", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"criptopeso", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"criptopeso", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"criptopeso", "checkbudgets", &checkbudgets, true, true, false},
        {"criptopeso", "mnsync", &mnsync, true, true, false},
        {"criptopeso", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> criptopeso-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8055/\n";
}
