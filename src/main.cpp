...
#if defined(NDEBUG)
#error "Criptopeso cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in upeso) are considered zero fee (for relaying and mining)
...
{
    RenameThread("criptopeso-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // PESO: We use certain sporks during IBD, so check to see if they are
