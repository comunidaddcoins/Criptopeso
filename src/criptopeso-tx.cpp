...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Criptopeso Core criptopeso-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  criptopeso-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded criptopeso transaction") + "\n" +
                               "  criptopeso-tx [options] -create [commands]   " + _("Create hex-encoded criptopeso transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded criptopeso transaction
