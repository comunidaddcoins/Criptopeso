...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Criptopeso Core"),
     ...
     * override -datadir in the criptopeso.conf file in the default data directory
     * (to be consistent with criptopesod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
