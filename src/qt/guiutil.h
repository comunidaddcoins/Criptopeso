...
/** Utility functions used by the Criptopeso Qt UI.
 */
namespace GUIUtil
{
...
// Render PESO addresses in monospace font
...
// Parse "criptopeso:" URI into recipient object, return true on successful parsing
