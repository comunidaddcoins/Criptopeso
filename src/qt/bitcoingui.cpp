                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Criptopeso Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PESO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and criptopeso: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Criptopeso Core"), this);
    aboutAction->setStatusTip(tr("Show information about Criptopeso Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Criptopeso"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PESO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PESO addresses"));
    ...
    openAction->setStatusTip(tr("Open a criptopeso: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Criptopeso Core help message to get a list with possible Criptopeso command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Criptopeso Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Criptopeso network", "", count));
}
...
{
    QString strTitle = tr("Criptopeso Core"); // default title
