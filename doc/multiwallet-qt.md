...
In order to support loading of multiple wallets in criptopeso-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is criptopeso.cpp.
...
Changes to criptopeso.cpp
----------------------
criptopeso.cpp is the entry point into criptopeso-qt, and as such, will require some minor modifications to provide hooks for
