...
Intro
-----
Criptopeso (PESO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Criptopeso utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run criptopeso-qt.exe.

Criptopeso Core is the original Criptopeso client and it builds the backbone of the network.
However, it downloads and stores the entire history of Criptopeso transactions;
