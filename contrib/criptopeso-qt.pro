...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/criptopeso-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/criptopeso-cli.cpp \
           src/criptopeso-tx.cpp \
           src/criptopeso.cpp \
           src/db.cpp \
           ...
           src/qt/criptopeso.cpp \
           src/qt/criptopesostrings.cpp \
...
RESOURCES += src/qt/criptopeso.qrc src/qt/criptopeso_locale.qrc

TRANSLATIONS += src/qt/locale/criptopeso_bg.ts \
                src/qt/locale/criptopeso_de.ts \
                src/qt/locale/criptopeso_en.ts \
                src/qt/locale/criptopeso_es.ts \
                src/qt/locale/criptopeso_fi.ts \
                src/qt/locale/criptopeso_fr.ts \
                src/qt/locale/criptopeso_it.ts \
                src/qt/locale/criptopeso_ja.ts \
                src/qt/locale/criptopeso_pl.ts \
                src/qt/locale/criptopeso_pt.ts \
                src/qt/locale/criptopeso_ru.ts \
                src/qt/locale/criptopeso_sk.ts \
                src/qt/locale/criptopeso_sv.ts \
                src/qt/locale/criptopeso_vi.ts \
                src/qt/locale/criptopeso_zh_CN.ts \
                src/qt/locale/criptopeso_zh_TW.ts
